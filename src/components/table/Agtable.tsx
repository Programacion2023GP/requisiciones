...
export const Agtable: React.FC<TypeTable> = ({
  ...
  useEffect(() => {
    if (
      ...
      setFiltersColapseOptions((prev) => ({
        ...prev,
        titles: Object.keys(dataTable.data.length > 0 ? dataTable.data[0] : {}), // Extrae las claves del primer elemento
      }));
    }
  ...
  const handleFilterChange = (params: {
    ...
    if (sqlWhereClause !== "") {
      ...
      console.log("No hay filtros, aplicando búsqueda inicial:", defaultWhere);
  ...
  function mergeWhereClauseAdvanced(
    ...
    return cleanedWhere ? `${cleanedWhere} AND ${newCondition}` : newCondition;
  }
