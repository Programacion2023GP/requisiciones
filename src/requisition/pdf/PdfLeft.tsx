    ...
    return (
        <View style={tw("w-1/2 border-r h-full py-2 relative")}>
                  ...
                  <View style={tw("mx-3")}>
                    <View
                      style={tw(
                        "flex flex-row mt-4 border-2 w-full justify-between"
                      )}
                    >
                      <Text style={tw("text-sm text-center")}>Cantidad</Text>
                      <Text style={tw("text-sm text-center")}>Descripción</Text>
                      {/* <Text style={tw("text-sm text-center")}>Clave Presupuestal</Text> */}
                    </View>
                  </View>
                  {products &&
                     products.map((producto, index) => (
                        ...
                        >
                          ...
                          <Text
                            style={tw("w-1/2 text-sm text-gray-800 text-center text-wrap")}
                          >
                  ...
                  <View
                    style={tw("mt-auto border-2 border-black mx-3 mb-20 pt-2")}
                  >
                    <Text style={tw("text-sm font-bold")}>Observaciones:</Text>
                    <Text style={tw("text-sm")}>
                    {pdfData?.Observaciones}
                    </Text>
                  </View>
                  <View style={tw("mx-3 ")}>
